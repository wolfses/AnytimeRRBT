...
class CVolumeObject : public C3DObject  
{
public:
	CVolumeObject();
	CVolumeObject(C3Vector size,float resolution);
	...
	bool cutVolume(const std::vector<float>& planes);
...
protected:
	...
	float _sideSize;
	C3Vector _originalSize;
	C3Vector _centerPosition;
	float _resolution;
	CVolumeNode* _volumeNode;
};
