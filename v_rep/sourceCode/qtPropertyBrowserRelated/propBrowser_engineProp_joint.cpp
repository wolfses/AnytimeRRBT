...
bool CPropBrowserEngineJoint::_vortexJointAxisFrictionExpanded=true;
bool CPropBrowserEngineJoint::_vortexJointAxisLimitsExpanded=true;
...
int CPropBrowserEngineJoint::_dlgSizeY=650;
...
void CPropBrowserEngineJoint::refresh()
{
	...
	// Bullet parameters:
	float bulletStopErp,bulletStopCfm,bulletNormalCfm;
	it->getBulletParameters(bulletStopErp,bulletStopCfm,bulletNormalCfm);
	p_bulletNormalCFM->setValue(tt::floatToString(bulletNormalCfm,false).c_str());
	p_bulletStopERP->setValue(tt::floatToString(bulletStopErp,false).c_str());
	p_bulletStopCFM->setValue(tt::floatToString(bulletStopCfm,false).c_str());
	...
	// ODE parameters:
	float odeStopErp,odeStopCfm,odeBounce,odeFudgeFactor,odeNormalCfm;
	it->getOdeParameters(odeStopErp,odeStopCfm,odeBounce,odeFudgeFactor,odeNormalCfm);
	p_odeNormalCFM->setValue(tt::floatToString(odeNormalCfm,false).c_str());
	p_odeStopERP->setValue(tt::floatToString(odeStopErp,false).c_str());
	p_odeStopCFM->setValue(tt::floatToString(odeStopCfm,false).c_str());
	p_odeBounce->setValue(tt::floatToString(odeBounce,false).c_str());
	p_odeFudgeFactor->setValue(tt::floatToString(odeFudgeFactor,false).c_str());
	...
	it->getVortexFloatParams(floatParams);
	it->getVortexIntParams(intParams);

	const float limit_lower_damping=floatParams[0];
	const float limit_upper_damping=floatParams[1];
	const float limit_lower_stiffness=floatParams[2];
	const float limit_upper_stiffness=floatParams[3];
	const float limit_lower_restitution=floatParams[4];
	const float limit_upper_restitution=floatParams[5];
	const float limit_lower_maxForce=floatParams[6];
	const float limit_upper_maxForce=floatParams[7];
	const float motorConstraint_friction_coeff=floatParams[8];
	const float motorConstraint_friction_maxForce=floatParams[9];
	const float motorConstraint_friction_loss=floatParams[10];
	const float P0_loss=floatParams[11];
	const float P0_stiffness=floatParams[12];
	const float P0_damping=floatParams[13];
	const float P0_friction_coeff=floatParams[14];
	const float P0_friction_maxForce=floatParams[15];
	const float P0_friction_loss=floatParams[16];
	const float P1_loss=floatParams[17];
	const float P1_stiffness=floatParams[18];
	const float P1_damping=floatParams[19];
	const float P1_friction_coeff=floatParams[20];
	const float P1_friction_maxForce=floatParams[21];
	const float P1_friction_loss=floatParams[22];
	const float P2_loss=floatParams[23];
	const float P2_stiffness=floatParams[24];
	const float P2_damping=floatParams[25];
	const float P2_friction_coeff=floatParams[26];
	const float P2_friction_maxForce=floatParams[27];
	const float P2_friction_loss=floatParams[28];
	const float A0_loss=floatParams[29];
	const float A0_stiffness=floatParams[30];
	const float A0_damping=floatParams[31];
	const float A0_friction_coeff=floatParams[32];
	const float A0_friction_maxForce=floatParams[33];
	const float A0_friction_loss=floatParams[34];
	const float A1_loss=floatParams[35];
	const float A1_stiffness=floatParams[36];
	const float A1_damping=floatParams[37];
	const float A1_friction_coeff=floatParams[38];
	const float A1_friction_maxForce=floatParams[39];
	const float A1_friction_loss=floatParams[40];
	const float A2_loss=floatParams[41];
	const float A2_stiffness=floatParams[42];
	const float A2_damping=floatParams[43];
	const float A2_friction_coeff=floatParams[44];
	const float A2_friction_maxForce=floatParams[45];
	const float A2_friction_loss=floatParams[46];
	...
	if (it->getJointType()!=sim_joint_spherical_subtype)
	{
		...
		p_vortexJointAxisFrictionCoefficient->setValue(tt::floatToString(motorConstraint_friction_coeff,false).c_str());
		p_vortexJointAxisFrictionCoefficient->setEnabled(motorFrictionEnabled&&motorFrictionProportional);
		if (it->getJointType()==sim_joint_prismatic_subtype)
		{
			p_vortexJointAxisFrictionMaxForce->setValue(tt::floatToString(tt::floatToUserFloat(motorConstraint_friction_maxForce,gv::forceToUser,true),false).c_str());
			p_vortexJointAxisFrictionLoss->setValue(tt::floatToString(tt::floatToUserFloat(motorConstraint_friction_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
		}
		else
		{
			p_vortexJointAxisFrictionMaxForce->setValue(tt::floatToString(tt::floatToUserFloat(motorConstraint_friction_maxForce,gv::torqueToUser,true),false).c_str());
			p_vortexJointAxisFrictionLoss->setValue(tt::floatToString(tt::floatToUserFloat(motorConstraint_friction_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
		}
		...
		p_vortexJointAxisLimitLowerRestitution->setValue(tt::floatToString(limit_lower_restitution,false).c_str());
		p_vortexJointAxisLimitLowerRestitution->setEnabled(true);
		p_vortexJointAxisLimitUpperRestitution->setValue(tt::floatToString(limit_upper_restitution,false).c_str());
		p_vortexJointAxisLimitUpperRestitution->setEnabled(true);
		if (it->getJointType()==sim_joint_prismatic_subtype)
		{
			p_vortexJointAxisLimitLowerStiffness->setValue(tt::floatToString(tt::floatToUserFloat(limit_lower_stiffness,gv::kilogramsToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
			p_vortexJointAxisLimitUpperStiffness->setValue(tt::floatToString(tt::floatToUserFloat(limit_upper_stiffness,gv::kilogramsToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
			p_vortexJointAxisLimitLowerDamping->setValue(tt::floatToString(tt::floatToUserFloat(limit_lower_damping,gv::kilogramsToUser/gv::secondsToUser,true),false).c_str());
			p_vortexJointAxisLimitUpperDamping->setValue(tt::floatToString(tt::floatToUserFloat(limit_upper_damping,gv::kilogramsToUser/gv::secondsToUser,true),false).c_str());
			p_vortexJointAxisLimitLowerMaxForce->setValue(tt::floatToString(tt::floatToUserFloat(limit_lower_maxForce,gv::forceToUser,true),false).c_str());
			p_vortexJointAxisLimitUpperMaxForce->setValue(tt::floatToString(tt::floatToUserFloat(limit_upper_maxForce,gv::forceToUser,true),false).c_str());
		}
		else
		{
			p_vortexJointAxisLimitLowerStiffness->setValue(tt::floatToString(tt::floatToUserFloat(limit_lower_stiffness,gv::kilogramsToUser*gv::meterToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
			p_vortexJointAxisLimitUpperStiffness->setValue(tt::floatToString(tt::floatToUserFloat(limit_upper_stiffness,gv::kilogramsToUser*gv::meterToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
			p_vortexJointAxisLimitLowerDamping->setValue(tt::floatToString(tt::floatToUserFloat(limit_lower_damping,gv::kilogramsToUser*gv::meterToUser/gv::secondsToUser,true),false).c_str());
			p_vortexJointAxisLimitUpperDamping->setValue(tt::floatToString(tt::floatToUserFloat(limit_upper_damping,gv::kilogramsToUser*gv::meterToUser/gv::secondsToUser,true),false).c_str());
			p_vortexJointAxisLimitLowerMaxForce->setValue(tt::floatToString(tt::floatToUserFloat(limit_lower_maxForce,gv::torqueToUser,true),false).c_str());
			p_vortexJointAxisLimitUpperMaxForce->setValue(tt::floatToString(tt::floatToUserFloat(limit_upper_maxForce,gv::torqueToUser,true),false).c_str());
		}
		...
		p_vortexRelaxationA0Stiffness->setValue(tt::floatToString(tt::floatToUserFloat(A0_stiffness,gv::kilogramsToUser*gv::meterToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
		p_vortexRelaxationA0Stiffness->setEnabled(A0_relaxation_enabled);
		p_vortexRelaxationA0Damping->setValue(tt::floatToString(tt::floatToUserFloat(A0_damping,gv::kilogramsToUser*gv::meterToUser/gv::secondsToUser,true),false).c_str());
		p_vortexRelaxationA0Damping->setEnabled(A0_relaxation_enabled);
		p_vortexRelaxationA0Loss->setValue(tt::floatToString(tt::floatToUserFloat(A0_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
		...
		p_vortexFrictionA0Coefficient->setValue(tt::floatToString(A0_friction_coeff,false).c_str());
		p_vortexFrictionA0Coefficient->setEnabled(A0_friction_enabled&&A0_friction_proportional);
		p_vortexFrictionA0MaxForce->setValue(tt::floatToString(tt::floatToUserFloat(A0_friction_maxForce,gv::torqueToUser,true),false).c_str());
		p_vortexFrictionA0MaxForce->setEnabled(A0_friction_enabled&&(!A0_friction_proportional));
		p_vortexFrictionA0Loss->setValue(tt::floatToString(tt::floatToUserFloat(A0_friction_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
		...
		p_vortexRelaxationA1Stiffness->setValue(tt::floatToString(tt::floatToUserFloat(A1_stiffness,gv::kilogramsToUser*gv::meterToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
		p_vortexRelaxationA1Stiffness->setEnabled(A1_relaxation_enabled);
		p_vortexRelaxationA1Damping->setValue(tt::floatToString(tt::floatToUserFloat(A1_damping,gv::kilogramsToUser*gv::meterToUser/gv::secondsToUser,true),false).c_str());
		p_vortexRelaxationA1Damping->setEnabled(A1_relaxation_enabled);
		p_vortexRelaxationA1Loss->setValue(tt::floatToString(tt::floatToUserFloat(A1_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
		...
		p_vortexFrictionA1Coefficient->setValue(tt::floatToString(A1_friction_coeff,false).c_str());
		p_vortexFrictionA1Coefficient->setEnabled(A1_friction_enabled&&A1_friction_proportional);
		p_vortexFrictionA1MaxForce->setValue(tt::floatToString(tt::floatToUserFloat(A1_friction_maxForce,gv::torqueToUser,true),false).c_str());
		p_vortexFrictionA1MaxForce->setEnabled(A1_friction_enabled&&(!A1_friction_proportional));
		p_vortexFrictionA1Loss->setValue(tt::floatToString(tt::floatToUserFloat(A1_friction_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
		...
		{ // prismatic joints
			...
			p_vortexRelaxationA2Stiffness->setValue(tt::floatToString(tt::floatToUserFloat(A2_stiffness,gv::kilogramsToUser*gv::meterToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
			p_vortexRelaxationA2Stiffness->setEnabled(A2_relaxation_enabled);
			p_vortexRelaxationA2Damping->setValue(tt::floatToString(tt::floatToUserFloat(A2_damping,gv::kilogramsToUser*gv::meterToUser/gv::secondsToUser,true),false).c_str());
			p_vortexRelaxationA2Damping->setEnabled(A2_relaxation_enabled);
			p_vortexRelaxationA2Loss->setValue(tt::floatToString(tt::floatToUserFloat(A2_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
			...
			p_vortexFrictionA2Coefficient->setValue(tt::floatToString(A2_friction_coeff,false).c_str());
			p_vortexFrictionA2Coefficient->setEnabled(A2_friction_enabled&&A2_friction_proportional);
			p_vortexFrictionA2MaxForce->setValue(tt::floatToString(tt::floatToUserFloat(A2_friction_maxForce,gv::torqueToUser,true),false).c_str());
			p_vortexFrictionA2MaxForce->setEnabled(A2_friction_enabled&&(!A2_friction_proportional));
			p_vortexFrictionA2Loss->setValue(tt::floatToString(tt::floatToUserFloat(A2_friction_loss,gv::secondsToUser/(gv::kilogramsToUser*gv::meterToUser*gv::meterToUser),true),false).c_str());
	...
	p_vortexRelaxationP0Stiffness->setValue(tt::floatToString(tt::floatToUserFloat(P0_stiffness,gv::kilogramsToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
	p_vortexRelaxationP0Stiffness->setEnabled(P0_relaxation_enabled);
	p_vortexRelaxationP0Damping->setValue(tt::floatToString(tt::floatToUserFloat(P0_damping,gv::kilogramsToUser/gv::secondsToUser,true),false).c_str());
	p_vortexRelaxationP0Damping->setEnabled(P0_relaxation_enabled);
	p_vortexRelaxationP0Loss->setValue(tt::floatToString(tt::floatToUserFloat(P0_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
	...
	p_vortexFrictionP0Coefficient->setValue(tt::floatToString(P0_friction_coeff,false).c_str());
	p_vortexFrictionP0Coefficient->setEnabled(P0_friction_enabled&&P0_friction_proportional);
	p_vortexFrictionP0MaxForce->setValue(tt::floatToString(tt::floatToUserFloat(P0_friction_maxForce,gv::forceToUser,true),false).c_str());
	p_vortexFrictionP0MaxForce->setEnabled(P0_friction_enabled&&(!P0_friction_proportional));
	p_vortexFrictionP0Loss->setValue(tt::floatToString(tt::floatToUserFloat(P0_friction_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
	...
	p_vortexRelaxationP1Stiffness->setValue(tt::floatToString(tt::floatToUserFloat(P1_stiffness,gv::kilogramsToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
	p_vortexRelaxationP1Stiffness->setEnabled(P1_relaxation_enabled);
	p_vortexRelaxationP1Damping->setValue(tt::floatToString(tt::floatToUserFloat(P1_damping,gv::kilogramsToUser/gv::secondsToUser,true),false).c_str());
	p_vortexRelaxationP1Damping->setEnabled(P1_relaxation_enabled);
	p_vortexRelaxationP1Loss->setValue(tt::floatToString(tt::floatToUserFloat(P1_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
	...
	p_vortexFrictionP1Coefficient->setValue(tt::floatToString(P1_friction_coeff,false).c_str());
	p_vortexFrictionP1Coefficient->setEnabled(P1_friction_enabled&&P1_friction_proportional);
	p_vortexFrictionP1MaxForce->setValue(tt::floatToString(tt::floatToUserFloat(P1_friction_maxForce,gv::forceToUser,true),false).c_str());
	p_vortexFrictionP1MaxForce->setEnabled(P1_friction_enabled&&(!P1_friction_proportional));
	p_vortexFrictionP1Loss->setValue(tt::floatToString(tt::floatToUserFloat(P1_friction_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
	...
	{ // revolute or spherical joints
		...
		p_vortexRelaxationP2Stiffness->setValue(tt::floatToString(tt::floatToUserFloat(P2_stiffness,gv::kilogramsToUser/(gv::secondsToUser*gv::secondsToUser),true),false).c_str());
		p_vortexRelaxationP2Stiffness->setEnabled(P2_relaxation_enabled);
		p_vortexRelaxationP2Damping->setValue(tt::floatToString(tt::floatToUserFloat(P2_damping,gv::kilogramsToUser/gv::secondsToUser,true),false).c_str());
		p_vortexRelaxationP2Damping->setEnabled(P2_relaxation_enabled);
		p_vortexRelaxationP2Loss->setValue(tt::floatToString(tt::floatToUserFloat(P2_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
		...
		p_vortexFrictionP2Coefficient->setValue(tt::floatToString(P2_friction_coeff,false).c_str());
		p_vortexFrictionP2Coefficient->setEnabled(P2_friction_enabled&&P2_friction_proportional);
		p_vortexFrictionP2MaxForce->setValue(tt::floatToString(tt::floatToUserFloat(P2_friction_maxForce,gv::forceToUser,true),false).c_str());
		p_vortexFrictionP2MaxForce->setEnabled(P2_friction_enabled&&(!P2_friction_proportional));
		p_vortexFrictionP2Loss->setValue(tt::floatToString(tt::floatToUserFloat(P2_friction_loss,gv::secondsToUser/gv::kilogramsToUser,true),false).c_str());
...
//	int a;
	...
	it->setBulletParameters(bulletStopErp,bulletStopCfm,bulletNormalCfm);
	...
	it->setOdeParameters(odeStopErp,odeStopCfm,odeBounce,odeFudgeFactor,odeNormalCfm);
	...
	float limit_lower_damping=floatParams[0];
	float limit_upper_damping=floatParams[1];
	float limit_lower_stiffness=floatParams[2];
	float limit_upper_stiffness=floatParams[3];
	float limit_lower_restitution=floatParams[4];
	float limit_upper_restitution=floatParams[5];
	float limit_lower_maxForce=floatParams[6];
	float limit_upper_maxForce=floatParams[7];
	float motorConstraint_friction_coeff=floatParams[8];
	float motorConstraint_friction_maxForce=floatParams[9];
	float motorConstraint_friction_loss=floatParams[10];
	float P0_loss=floatParams[11];
	float P0_stiffness=floatParams[12];
	float P0_damping=floatParams[13];
	float P0_friction_coeff=floatParams[14];
	float P0_friction_maxForce=floatParams[15];
	float P0_friction_loss=floatParams[16];
	float P1_loss=floatParams[17];
	float P1_stiffness=floatParams[18];
	float P1_damping=floatParams[19];
	float P1_friction_coeff=floatParams[20];
	float P1_friction_maxForce=floatParams[21];
	float P1_friction_loss=floatParams[22];
	float P2_loss=floatParams[23];
	float P2_stiffness=floatParams[24];
	float P2_damping=floatParams[25];
	float P2_friction_coeff=floatParams[26];
	float P2_friction_maxForce=floatParams[27];
	float P2_friction_loss=floatParams[28];
	float A0_loss=floatParams[29];
	float A0_stiffness=floatParams[30];
	float A0_damping=floatParams[31];
	float A0_friction_coeff=floatParams[32];
	float A0_friction_maxForce=floatParams[33];
	float A0_friction_loss=floatParams[34];
	float A1_loss=floatParams[35];
	float A1_stiffness=floatParams[36];
	float A1_damping=floatParams[37];
	float A1_friction_coeff=floatParams[38];
	float A1_friction_maxForce=floatParams[39];
	float A1_friction_loss=floatParams[40];
	float A2_loss=floatParams[41];
	float A2_stiffness=floatParams[42];
	float A2_damping=floatParams[43];
	float A2_friction_coeff=floatParams[44];
	float A2_friction_maxForce=floatParams[45];
	float A2_friction_loss=floatParams[46];
	bool motorFrictionEnabled=((intParams[0]&1)!=0);
	bool motorFrictionProportional=((intParams[0]&2)!=0);
	bool P0_relaxation_enabled=((intParams[1]&1)!=0);
	bool P1_relaxation_enabled=((intParams[1]&2)!=0);
	bool P2_relaxation_enabled=((intParams[1]&4)!=0);
	bool A0_relaxation_enabled=((intParams[1]&8)!=0);
	bool A1_relaxation_enabled=((intParams[1]&16)!=0);
	bool A2_relaxation_enabled=((intParams[1]&32)!=0);
	bool P0_friction_enabled=((intParams[2]&1)!=0);
	bool P1_friction_enabled=((intParams[2]&2)!=0);
	bool P2_friction_enabled=((intParams[2]&4)!=0);
	bool A0_friction_enabled=((intParams[2]&8)!=0);
	bool A1_friction_enabled=((intParams[2]&16)!=0);
	bool A2_friction_enabled=((intParams[2]&32)!=0);
	bool P0_friction_proportional=((intParams[3]&1)!=0);
	bool P1_friction_proportional=((intParams[3]&2)!=0);
	bool P2_friction_proportional=((intParams[3]&4)!=0);
	bool A0_friction_proportional=((intParams[3]&8)!=0);
	bool A1_friction_proportional=((intParams[3]&16)!=0);
	bool A2_friction_proportional=((intParams[3]&32)!=0);

	if (_prop==p_vortexJointAxisFrictionEnabled)
		motorFrictionEnabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexJointAxisFrictionProportional)
		motorFrictionProportional=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexJointAxisFrictionCoefficient)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			motorConstraint_friction_coeff=f;
	}
	if (_prop==p_vortexJointAxisFrictionMaxForce)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				motorConstraint_friction_maxForce=tt::userFloatToFloat(f,gv::userToForce,true);
			else
				motorConstraint_friction_maxForce=tt::userFloatToFloat(f,gv::userToTorque,true);
		}
	}
	if (_prop==p_vortexJointAxisFrictionLoss)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				motorConstraint_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
			else
				motorConstraint_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
		}
	}
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			limit_lower_restitution=f;
	}
	if (_prop==p_vortexJointAxisLimitUpperRestitution)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			limit_upper_restitution=f;
	}
	if (_prop==p_vortexJointAxisLimitLowerStiffness)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				limit_lower_stiffness=tt::userFloatToFloat(f,gv::userToKilograms/(gv::userToSeconds*gv::userToSeconds),true);
			else
				limit_lower_stiffness=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/(gv::userToSeconds*gv::userToSeconds),true);
		}
	}
	if (_prop==p_vortexJointAxisLimitUpperStiffness)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				limit_upper_stiffness=tt::userFloatToFloat(f,gv::userToKilograms/(gv::userToSeconds*gv::userToSeconds),true);
			else
				limit_upper_stiffness=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/(gv::userToSeconds*gv::userToSeconds),true);
		}
	}
	if (_prop==p_vortexJointAxisLimitLowerDamping)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				limit_lower_damping=tt::userFloatToFloat(f,gv::userToKilograms/gv::userToSeconds,true);
			else
				limit_lower_damping=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/gv::userToSeconds,true);
		}
	}
	if (_prop==p_vortexJointAxisLimitUpperDamping)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				limit_upper_damping=tt::userFloatToFloat(f,gv::userToKilograms/gv::userToSeconds,true);
			else
				limit_upper_damping=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/gv::userToSeconds,true);
		}
	}
	if (_prop==p_vortexJointAxisLimitLowerMaxForce)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				limit_lower_maxForce=tt::userFloatToFloat(f,gv::userToForce,true);
			else
				limit_lower_maxForce=tt::userFloatToFloat(f,gv::userToTorque,true);
		}
	}
	if (_prop==p_vortexJointAxisLimitUpperMaxForce)
	{
		...
		{
			if (it->getJointType()==sim_joint_prismatic_subtype)
				limit_upper_maxForce=tt::userFloatToFloat(f,gv::userToForce,true);
			else
				limit_upper_maxForce=tt::userFloatToFloat(f,gv::userToTorque,true);
		}
	}
	...
	if (_prop==p_vortexRelaxationP0Enabled)
		P0_relaxation_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexRelaxationP0Stiffness)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P0_stiffness=tt::userFloatToFloat(f,gv::userToKilograms/(gv::userToSeconds*gv::userToSeconds),true);
	}
	if (_prop==p_vortexRelaxationP0Damping)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P0_damping=tt::userFloatToFloat(f,gv::userToKilograms/gv::userToSeconds,true);
	}
	if (_prop==p_vortexRelaxationP0Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P0_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
	}
	if (_prop==p_vortexFrictionP0Enabled)
		P0_friction_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexFrictionP0Proportional)
		P0_friction_proportional=((QtVariantProperty*)_prop)->value().toBool();
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P0_friction_maxForce=tt::userFloatToFloat(f,gv::userToForce,true);
	}
	if (_prop==p_vortexFrictionP0Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P0_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
	}

	// P1
	if (_prop==p_vortexRelaxationP1Enabled)
		P1_relaxation_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexRelaxationP1Stiffness)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P1_stiffness=tt::userFloatToFloat(f,gv::userToKilograms/(gv::userToSeconds*gv::userToSeconds),true);
	}
	if (_prop==p_vortexRelaxationP1Damping)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P1_damping=tt::userFloatToFloat(f,gv::userToKilograms/gv::userToSeconds,true);
	}
	if (_prop==p_vortexRelaxationP1Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P1_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
	}
	if (_prop==p_vortexFrictionP1Enabled)
		P1_friction_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexFrictionP1Proportional)
		P1_friction_proportional=((QtVariantProperty*)_prop)->value().toBool();
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P1_friction_maxForce=tt::userFloatToFloat(f,gv::userToForce,true);
	}
	if (_prop==p_vortexFrictionP1Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P1_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
	}

	// P2
	if (_prop==p_vortexRelaxationP2Enabled)
		P2_relaxation_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexRelaxationP2Stiffness)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P2_stiffness=tt::userFloatToFloat(f,gv::userToKilograms/(gv::userToSeconds*gv::userToSeconds),true);
	}
	if (_prop==p_vortexRelaxationP2Damping)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P2_damping=tt::userFloatToFloat(f,gv::userToKilograms/gv::userToSeconds,true);
	}
	if (_prop==p_vortexRelaxationP2Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P2_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
	}
	if (_prop==p_vortexFrictionP2Enabled)
		P2_friction_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexFrictionP2Proportional)
		P2_friction_proportional=((QtVariantProperty*)_prop)->value().toBool();
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P2_friction_maxForce=tt::userFloatToFloat(f,gv::userToForce,true);
	}
	if (_prop==p_vortexFrictionP2Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			P2_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/gv::userToKilograms,true);
	}


	// A0
	if (_prop==p_vortexRelaxationA0Enabled)
		A0_relaxation_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexRelaxationA0Stiffness)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A0_stiffness=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/(gv::userToSeconds*gv::userToSeconds),true);
	}
	if (_prop==p_vortexRelaxationA0Damping)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A0_damping=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/gv::userToSeconds,true);
	}
	if (_prop==p_vortexRelaxationA0Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A0_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
	}
	if (_prop==p_vortexFrictionA0Enabled)
		A0_friction_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexFrictionA0Proportional)
		A0_friction_proportional=((QtVariantProperty*)_prop)->value().toBool();
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A0_friction_maxForce=tt::userFloatToFloat(f,gv::userToTorque,true);
	}
	if (_prop==p_vortexFrictionA0Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A0_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
	}


	// A1
	if (_prop==p_vortexRelaxationA1Enabled)
		A1_relaxation_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexRelaxationA1Stiffness)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A1_stiffness=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/(gv::userToSeconds*gv::userToSeconds),true);
	}
	if (_prop==p_vortexRelaxationA1Damping)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A1_damping=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/gv::userToSeconds,true);
	}
	if (_prop==p_vortexRelaxationA1Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A1_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
	}
	if (_prop==p_vortexFrictionA1Enabled)
		A1_friction_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexFrictionA1Proportional)
		A1_friction_proportional=((QtVariantProperty*)_prop)->value().toBool();
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A1_friction_maxForce=tt::userFloatToFloat(f,gv::userToTorque,true);
	}
	if (_prop==p_vortexFrictionA1Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A1_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
	}

	// A2
	if (_prop==p_vortexRelaxationA2Enabled)
		A2_relaxation_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexRelaxationA2Stiffness)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A2_stiffness=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/(gv::userToSeconds*gv::userToSeconds),true);
	}
	if (_prop==p_vortexRelaxationA2Damping)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A2_damping=tt::userFloatToFloat(f,gv::userToKilograms*gv::userToMeter/gv::userToSeconds,true);
	}
	if (_prop==p_vortexRelaxationA2Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A2_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
	}
	if (_prop==p_vortexFrictionA2Enabled)
		A2_friction_enabled=((QtVariantProperty*)_prop)->value().toBool();
	if (_prop==p_vortexFrictionA2Proportional)
		A2_friction_proportional=((QtVariantProperty*)_prop)->value().toBool();
	...
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A2_friction_maxForce=tt::userFloatToFloat(f,gv::userToTorque,true);
	}
	if (_prop==p_vortexFrictionA2Loss)
	{
		if (tt::stringToFloat(((QtVariantProperty*)_prop)->value().toString().toStdString().c_str(),f,false,false))
			A2_friction_loss=tt::userFloatToFloat(f,gv::userToSeconds/(gv::userToKilograms*gv::userToMeter*gv::userToMeter),true);
	}


	floatParams[0]=limit_lower_damping;
	floatParams[1]=limit_upper_damping;
	floatParams[2]=limit_lower_stiffness;
	floatParams[3]=limit_upper_stiffness;
	floatParams[4]=limit_lower_restitution;
	floatParams[5]=limit_upper_restitution;
	floatParams[6]=limit_lower_maxForce;
	floatParams[7]=limit_upper_maxForce;
	floatParams[8]=motorConstraint_friction_coeff;
	floatParams[9]=motorConstraint_friction_maxForce;
	floatParams[10]=motorConstraint_friction_loss;
	floatParams[11]=P0_loss;
	floatParams[12]=P0_stiffness;
	floatParams[13]=P0_damping;
	floatParams[14]=P0_friction_coeff;
	floatParams[15]=P0_friction_maxForce;
	floatParams[16]=P0_friction_loss;
	floatParams[17]=P1_loss;
	floatParams[18]=P1_stiffness;
	floatParams[19]=P1_damping;
	floatParams[20]=P1_friction_coeff;
	floatParams[21]=P1_friction_maxForce;
	floatParams[22]=P1_friction_loss;
	floatParams[23]=P2_loss;
	floatParams[24]=P2_stiffness;
	floatParams[25]=P2_damping;
	floatParams[26]=P2_friction_coeff;
	floatParams[27]=P2_friction_maxForce;
	floatParams[28]=P2_friction_loss;
	floatParams[29]=A0_loss;
	floatParams[30]=A0_stiffness;
	floatParams[31]=A0_damping;
	floatParams[32]=A0_friction_coeff;
	floatParams[33]=A0_friction_maxForce;
	floatParams[34]=A0_friction_loss;
	floatParams[35]=A1_loss;
	floatParams[36]=A1_stiffness;
	floatParams[37]=A1_damping;
	floatParams[38]=A1_friction_coeff;
	floatParams[39]=A1_friction_maxForce;
	floatParams[40]=A1_friction_loss;
	floatParams[41]=A2_loss;
	floatParams[42]=A2_stiffness;
	floatParams[43]=A2_damping;
	floatParams[44]=A2_friction_coeff;
	floatParams[45]=A2_friction_maxForce;
	floatParams[46]=A2_friction_loss;
	intParams[0]=0;
	if (motorFrictionEnabled)
		intParams[0]|=1;
	if (motorFrictionProportional)
		intParams[0]|=2;
	intParams[1]=0;
	if (P0_relaxation_enabled)
		intParams[1]|=1;
	...
	if (A2_friction_enabled)
		intParams[2]|=32;
	intParams[3]=0;
	if (P0_friction_proportional)
		intParams[3]|=1;
	if (P1_friction_proportional)
		intParams[3]|=2;
	if (P2_friction_proportional)
		intParams[3]|=4;
	if (A0_friction_proportional)
		intParams[3]|=8;
	if (A1_friction_proportional)
		intParams[3]|=16;
	if (A2_friction_proportional)
		intParams[3]|=32;

	it->setVortexFloatParams(floatParams);
	it->setVortexIntParams(intParams);
