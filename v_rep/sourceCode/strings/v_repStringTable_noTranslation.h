...
#define IDSNOTR_FUNCTION_CALL_ERROR_C_API "Function call error (C-API): "
...
#define IDS_LEAVE_ELEMENT_EDIT_MODE "Leave user interface edit mode"
#define IDS_ENTER_ELEMENT_EDIT_MODE "Enter user interface edit mode"
...
#define IDS_TOOLBAR_TOOLTIP_2DELEMENTS "Custom user interfaces"
